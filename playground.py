...
#plt.subplot(1, 2, 1)
plt.title("broetchen_verzehr")
plt.ylabel("broetchen")
plt.xlabel("personen")
# sample = dataframe.sample(n=300)

dataframe["broetchen_verzehr"] = (dataframe["bestellmenge"] - dataframe["rest"])

sample = dataframe.sample(n=12)
print(sample.describe())
print(sample["personen"])
print(sample["broetchen_verzehr"])
plt.scatter(sample["personen"], sample["broetchen_verzehr"])
plt.show()
#
